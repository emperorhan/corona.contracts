...
typedef eosio::singleton<eosio::name("config"), ConfigInfo> configSingleton;

typedef eosio::multi_index<eosio::name("users"), UserInfo,
                           eosio::indexed_by<eosio::name("byscores"), eosio::const_mem_fun<UserInfo, double, &UserInfo::by_scores> >,
                           eosio::indexed_by<eosio::name("byconfirms"), eosio::const_mem_fun<UserInfo, double, &UserInfo::by_confirmed_scores> >,
                           eosio::indexed_by<eosio::name("byorders"), eosio::const_mem_fun<UserInfo, uint64_t, &UserInfo::by_orders> > >
    usersTable;

typedef eosio::multi_index<eosio::name("donates"), DonateInfo,
                           eosio::indexed_by<eosio::name("byowners"), eosio::const_mem_fun<DonateInfo, uint64_t, &DonateInfo::by_owners> > >
    donatesTable;
...
class [[eosio::contract("corona")]] corona : public eosio::contract {
   ...
   public:
    ...
    [[eosio::action]] void setuser(const eosio::name& owner);

    [[eosio::action]] void regsuspect(const eosio::name& owner);
